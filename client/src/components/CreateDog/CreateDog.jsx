...
export default function CreateDog () {
    ...
    const history = useNavigate()  // método del router que me redirige a la ruta que yo le diga 
        ...
        <div className={styles.container}>
          ...
          onSubmit={(e) => handleSubmit(e)}>
            <div><label>Name: </label>
                        ...
                        <div className={styles.temps}> <label>Select Temperaments: </label>
                        <select className={styles.templist} name="temperament" onChange={(e) => handleSelect(e)}  type="text" >
                                ...
                                { temps.map((temp, id) =>{  //uso React.Fragment por que tiene la prop key y pasarle el id de cada temp para renderizarlo y que la persona pueda verlo y quitarlo de la lista 
                                    return ( 
